 ...
 * @Last Modified time: 2020-02-04 16:48:09
 */
...
class BinarySearchTree {
 public:
  ...
  const Comparable& findMin() const { return (findMin(this->root))->element; }
  const Comparable& findMax() const { return (findMax(this->root))->element; }
  bool constains(const Comparable& x) const { return contains(x, root); }
